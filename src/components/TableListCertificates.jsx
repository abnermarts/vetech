...
import DialogDetailCertificate from "./DialogDetailCertificate";
import "react-loading-skeleton/dist/skeleton.css";
import Skeleton from "react-loading-skeleton";

export function TableListCertificate({ columns, data, isLoading = false }) {
  ...
  return (
    <div className="w-full h-auto justify-center items-center">
      ...
      {/* Dialog fora da tabela */}
      {dialogData && (
        <DialogDetailCertificate
          data={dialogData}
          open={!!dialogData}
          onOpenChange={(open) => {
