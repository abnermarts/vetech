...
import { DialogCertificateDetail } from "./CertificateDetail/DialogCertificateDetail";

export function TableLisExam({ columns, data, columnsName, isLoading }) {
          ...
          <TableBody>
            {isLoading ? (
              ...
              table.getRowModel().rows.map((row) => (
                <DialogCertificateDetail key={row.id} row={row.original} asChild>
                  <TableRow
